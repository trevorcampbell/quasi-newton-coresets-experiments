...
def run(arguments):
    ...
    projector_500 = bc.BlackBoxProjector(sample_w, 500, model.log_likelihood,
                                     model.grad_log_likelihood)
    projector_100 = bc.BlackBoxProjector(sample_w, 100, model.log_likelihood,
                                         model.grad_log_likelihood)
    projector_50 = bc.BlackBoxProjector(sample_w, 50, model.log_likelihood,
                                         model.grad_log_likelihood)
    projector_10 = bc.BlackBoxProjector(sample_w, 10, model.log_likelihood,
                                         model.grad_log_likelihood)
    projector_1000 = bc.BlackBoxProjector(sample_w, 1000, model.log_likelihood,
                                         model.grad_log_likelihood)
    ...
    newton_10 = bc.QuasiNewtonCoreset(Z, projector_10, opt_itrs=arguments.newton_opt_itrs)
    newton_50 = bc.QuasiNewtonCoreset(Z, projector_50, opt_itrs=arguments.newton_opt_itrs)
    newton_100 = bc.QuasiNewtonCoreset(Z, projector_100, opt_itrs=arguments.newton_opt_itrs)
    newton_500 = bc.QuasiNewtonCoreset(Z, projector_500, opt_itrs=arguments.newton_opt_itrs)
    newton_1000 = bc.QuasiNewtonCoreset(Z, projector_1000, opt_itrs=arguments.newton_opt_itrs)
    ...
    algs = {'SVI': sparsevi,
            ...
            'QNC-S=10': newton_10,
            'QNC-S=50': newton_50,
            'QNC-S=100': newton_100,
            'QNC-S=500': newton_500,
            'QNC-S=1000': newton_1000,
            'LAP': lapl,
            'GIGA': giga,
            'UNIF': unif,
            'IHT': iht,
...
parser.add_argument('--alg', type=str, default='UNIF',
                    choices=['SVI', 'QNC', 'GIGA', 'UNIF', 'LAP', 'IHT','FULL','NAIVE', 'GIGA-LAP', 'IHT-LAP', 'QNC-S=10', 'QNC-S=50', 'QNC-S=100', 'QNC-S=500', 'QNC-S=1000'],
