...
def run(arguments):
    ...
    newton_0 = bc.QuasiNewtonCoreset(Z, projector, opt_itrs=arguments.newton_opt_itrs, tune_itrs=0)
    newton_1 = bc.QuasiNewtonCoreset(Z, projector, opt_itrs=arguments.newton_opt_itrs, tune_itrs=1)
    newton_2 = bc.QuasiNewtonCoreset(Z, projector, opt_itrs=arguments.newton_opt_itrs, tune_itrs=2)
    newton_5 = bc.QuasiNewtonCoreset(Z, projector, opt_itrs=arguments.newton_opt_itrs, tune_itrs=5)
    newton_10 = bc.QuasiNewtonCoreset(Z, projector, opt_itrs=arguments.newton_opt_itrs, tune_itrs=10)


    algs = {'SVI': sparsevi,
            'QNC': newton,
            'QNC-K_tune=0': newton_0,
            'QNC-K_tune=1': newton_1,
            'QNC-K_tune=2': newton_2,
            'QNC-K_tune=5': newton_5,
            'QNC-K_tune=10': newton_10,
            'LAP': lapl,
            'GIGA': giga,
            'UNIF': unif,
            'IHT': iht,
...
parser.add_argument('--alg', type=str, default='UNIF',
                    choices=['SVI', 'QNC', 'GIGA', 'UNIF', 'LAP', 'IHT','FULL','NAIVE', 'GIGA-LAP', 'IHT-LAP', 'QNC-K_tune=0', 'QNC-K_tune=1', 'QNC-K_tune=2', 'QNC-K_tune=5', 'QNC-K_tune=10'],
